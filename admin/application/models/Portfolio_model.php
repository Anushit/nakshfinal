<?php
	class Portfolio_model extends CI_Model{
		...
		public function get_portfolio_for_export(){
			...
			$this->db->select('id, name, sort_description, description, feature, sort_order,meta_title, created_at,created_by');
		...
		public function getTotalportfolio($data = array()) {
			$sql = "SELECT COUNT(ci_portfolio.id) AS total";
 			$sql .= " FROM ci_portfolio";  
