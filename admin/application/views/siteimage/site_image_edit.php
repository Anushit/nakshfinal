              ...
              <div class="form-group row">
               ...
               <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="col-md-6">
                    <label class="control-label">Image/Video</label><br/>
                      <?php if(!empty($site_image['image'])): ?>
                         <p><img src="<?= base_url($site_image['image']); ?>" class="image logosmallimg"></p>
                      <?php endif; ?>
                      <input type="file" name="image" >
                      <p><small class="text-success">Allowed Types: gif, jpg, png, jpeg, mp4<br><?= $site_image['size_suggestion']; ?></small></p>
  ...
  $(document).ready(function(){     
     $("#siteimgForm").validate({
        rules: {
            ...
            status: "required",
            image:{
                  extension:"jpg|png|gif|jpeg|mp4",
                  },
        },
        messages: {
            ...
            image:{
                    extension:"Please upload file in these format only (jpg, jpeg, png, gif, mp4)",
                     },
        },
    });
