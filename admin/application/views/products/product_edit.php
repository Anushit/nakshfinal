            ...
            <?php echo form_open_multipart(base_url('product/edit/'.$pro['id']), 'class="form-horizontal" id="productForm"');  ?> 
              ...
              <div class="form-group row">               
                <div class="col-sm-12">
                   ...
                   <textarea name="demo_link"  class="form-control textarea" id="demo_link" placeholder="" ><?= set_value('demo_link',$pro['demo_link']); ?></textarea> 
                </div> 
              </div>
...
">*<small>(Space/special characters doesn't allowed)</small></span></label>
                  <input type="text" oninput="test(this.value)" name="slug" class="form-control" id="slug" placeholder="" value="<?= set_value('slug',$pro['slug']); ?>"> 
                </div>                     
                <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-6">    
                 ...
                 <div class="row"><div class="col-sm-6"><input type="file" name="image[<?=$image_row?>][image]" id="image"> <small class="text-success" style="vertical-align: top;">Allowed Types: gif, jpg, png, jpeg</small></div> 
                <?php $htmlData="";   
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" name="amazon_link" class="form-control" id="amazon_link" placeholder="" value="<?= set_value('amazon_link',$pro['amazon_link']); ?>"> 
                </div>
                <div class="col-sm-6">
                  <label for="filpcart_link" class="col-sm-6 control-label">Filpcart Link<span class="red">*</span></label>
                  <input type="text" name="filpcart_link" class="form-control" id="filpcart_link" placeholder="" value="<?= set_value('filpcart_link',$pro['filpcart_link']); ?>"> 
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-12">
