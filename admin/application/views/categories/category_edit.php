                ...
                <div class="col-sm-6">
                  ...
                  <select class="form-control select2" name="parent_id" required="" id="parent_id"  onchange="getsubcategroy(this.value)" >
                   ...
                   foreach ($parcat as $key => $pcat) { ?>
                    <option value="<?php echo $pcat['id']?>" <?= (set_value('parent_id',$cat['parent_id']) == $pcat['id'])?'selected': '' ?> ><?php echo $pcat['name']?></option>
                   <?php } ?>                   
                  </select> 
                </div> 
                <div class="col-sm-6">
...
">*<small>(Space/special characters doesn't allowed)</small></span></label>
                  <input type="text"  oninput="test(this.value)" name="slug" class="form-control" id="slug" placeholder="" value="<?= set_value('slug',$cat['slug']); ?>"> 
                </div>
                <div class="col-md-6">
