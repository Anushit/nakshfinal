                      ...
                      <?php foreach ($general_settings[$key] as $skey => $svalue) { 
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                             ...
                             <p><small class="text-success">Allowed Types: gif, jpg, png, jpeg</small>
                              <?php if ($svalue['filed_name']=='logo') { ?>
                             <span class="red" style="color: red;">*<small>(Logo size should be 253*65 in pixels)</small></span> 
                           <?php } ?>
                             </p>
